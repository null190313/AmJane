...
public class SessionUtils {
     ...
     * @Param : key 存储到session中的对象的变量名
     * @Param : value 存储的任意数据
     * @Param : maxInactiveInterval session过期时间
     * @Return :
     * @createTime : 2019/1/2 17:12
     * @description : TODO
     * @Version : 1.0
     *------------------------------
     */
    public static void pushMaxInactiveInterval(String key, Object value,int maxInactiveInterval) {
        HttpServletRequest request = request =
                ((ServletRequestAttributes) RequestContextHolder.getRequestAttributes()).getRequest();
