...
public class SysConfigEntity {
    ...
    private Integer sysConfigState;
    ...
    private String sysConfigDescription;


    public void setSysConfigDescription(String sysConfigDescription) {
        this.sysConfigDescription = sysConfigDescription;
    }

    public String getSysConfigDescription() {
    ...
    public void setSysConfigState(Integer sysConfigState) {
    ...
    public Integer getSysConfigState() {
