...
import org.lxrookie.start.substance.services.feignclient.configuration.EurekaLogsConfiguration;
...
@FeignClient(name = "EurekaLogsServer",
             //url="http://www.rookieboy.cn:81/logs",
             path = "/logs",
             configuration = EurekaLogsConfiguration.class,
