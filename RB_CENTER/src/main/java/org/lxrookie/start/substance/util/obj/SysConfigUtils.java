...
public class SysConfigUtils {
    ...
    */
    public static String getSysConfigByKey(String key){
        SysConfigServices sysConfigServices = (SysConfigServices) SpringUtils.getBean("sysConfigServices");
        return sysConfigServices.selectSysConfigByKey(key).getSysConfigValue() == null ? "" : sysConfigServices.selectSysConfigByKey(key).getSysConfigValue();
    }
